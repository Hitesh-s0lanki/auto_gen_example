...
class Creator(RoutedAgent):
    ...
    def get_user_prompt(self):
        ...
        with open("src/projects/agent_creation/agent.py", "r", encoding="utf-8") as f:
            template = f.read()
    ...
    async def handle_my_message_type(self, message: messages.Message, ctx: MessageContext) -> messages.Message:
        ...
        with open(f"src/projects/agent_creation/agents/{filename}", "w", encoding="utf-8") as f:
        ...
        module = importlib.import_module(f"src.projects.agent_creation.agents.{agent_name}")
